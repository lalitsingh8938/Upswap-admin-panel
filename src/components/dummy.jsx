...
// import React, { useState } from 'react';
// import PdfPreview from './PdfPreview'; // Ensure the correct path to PdfPreview
...
//       type: file.type,
//     }));
//     // Assuming you want to preview the first selected PDF
//     const pdfFile = documentsArray.find((doc) => doc.type === 'application/pdf');
//     if (pdfFile) {
