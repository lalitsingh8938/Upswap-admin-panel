...
//       <h1 className="text-2xl font-bold mb-4">Simple PDF Viewer</h1>
...
//       <div className="border shadow-lg w-full max-w-2xl h-[500px] overflow-auto bg-white">
//         {pdfFile ? (
//           <Document file={pdfFile} className="p-2">
//             <Page pageNumber={1} />
//           </Document>
//         ) : (
//           <p className="text-gray-500 text-center p-4">Upload a PDF to view</p>
//         )}
//       </div>
//     </div>
//   );
